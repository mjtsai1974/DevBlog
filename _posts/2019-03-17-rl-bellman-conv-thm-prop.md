...
>=$\vert\alpha_{U_{1}}\cdot(R(S,A)+\gamma\cdot\sum_{S'}P_{U_{1}}(S'\vert S,A)\cdot max_{A'}Q_{T-1}(S',A')-Q_{T-1}(S,A))$  
>-$\alpha_{U_{2}}\cdot(R(S,A)+\gamma\cdot\sum_{S'}P_{U_{2}}(S'\vert S,A)\cdot max_{A'}Q_{T-1}(S',A')-Q_{T-1}(S,A))\vert$  
>
