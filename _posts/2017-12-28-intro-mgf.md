...
>&#10112;the mean, $\mu=E\lbrack X\rbrack$, also called the first ordinary moment of random variable $X$.  More precisely, denoted by $\mu_1$.  
>&#10113;the variance, $\sigma^2=Var\lbrack X\rbrack=E\lbrack X^2\rbrack-E^2\lbrack X\rbrack$, also called the second ordinary moment, denoted by $\mu_2$.  
...
>$M_X(t)=E\lbrack e^{X\cdot t}\rbrack$  
>$\;\;\;\;=E\lbrack 1+\frac{t\cdot x}{1!}+\frac{(t\cdot x)^2}{2!}+\frac{(t\cdot x)^3}{3!}+\cdots+\frac{(t\cdot x)^k}{k!}+\cdots\rbrack$  
