...
>
>&#10114;we have the k-th differential of $M_X(t)$ with respect to $t^k$:  
>$\frac{\operatorname^k dM_X(t)}{\operatorname dt^k}$=$\mu_k$+$t\cdot \mu_{k+1}$+$\frac{t^2}{2!}\cdot \mu_{k+2}$+$\cdots$  
>
